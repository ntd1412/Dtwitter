    ...
    public class UserRegistrationCommandValidator : AbstractValidator<UserRegistrationCommand>
    {
        public UserRegistrationCommandValidator()
        {
            ...
            RuleFor(x => x.DateOfBirth)
                ...
                .Must(x => x.Year < DateTime.Now.Year - 12).WithMessage("You must be at least 12 years old to register")
                .Must(x => x.Year > DateTime.Now.Year - 99).WithMessage("Your age must be realistic");
        }
